...
export const inlineCommentPopoverPath = resolveWebSourcePath("components/cr-inline-comment-popover.ts");
...
export const renderMarkdownPath = resolveWebSourcePath("components/render-markdown.ts");
