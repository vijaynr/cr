...
import reviewAggregatePrompt from "../../../../resources/prompts/review-aggregate.txt" with { type: "text" };
import cleanCodeReviewAgentPrompt from "../../../../resources/prompts/review-agents/clean-code.txt" with { type: "text" };
import generalReviewAgentPrompt from "../../../../resources/prompts/review-agents/general.txt" with { type: "text" };
import performanceReviewAgentPrompt from "../../../../resources/prompts/review-agents/performance.txt" with { type: "text" };
import securityReviewAgentPrompt from "../../../../resources/prompts/review-agents/security.txt" with { type: "text" };
import summarizePrompt from "../../../../resources/prompts/summarize.txt" with { type: "text" };
import testQualityReviewAgentPrompt from "../../../../resources/prompts/review-agents/test-quality.txt" with { type: "text" };
...
import specThreat from "../../../../resources/specs/templates/threat-model.md" with { type: "text" };
