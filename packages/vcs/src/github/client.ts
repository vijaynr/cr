...
export class GitHubClient {
  ...
  async updatePullRequestComment(
    ...
    const comment = await this.http.patch<GitHubIssueComment>(
  ...
  async deletePullRequestComment(repoPath: string, commentId: number): Promise<void> {
    await this.http.delete<void>(`/repos/${repoPath}/issues/comments/${commentId}`);
  }
  ...
  async updateReviewComment(
    ...
    const comment = await this.http.patch<GitHubReviewComment>(
      `/repos/${repoPath}/pulls/comments/${commentId}`,
      { body }
    );
    return comment.html_url;
  }

  async deleteReviewComment(repoPath: string, commentId: number): Promise<void> {
    await this.http.delete<void>(`/repos/${repoPath}/pulls/comments/${commentId}`);
  }
